	...
	<view>
		<form class="w100" @submit="formSubmit">
		  <view class='container'>
		    ...
		    <view class="msg_box" @tap="jump" data-url="/pages/my_name/my_name">
		    ...
		    <view class="msg_box" @tap="jump" data-url="/pages/my_jj/my_jj">
		      <text class="msg_name">简介</text>
		       <view class="dis_flex aic msg_val">{{'我就是我不一样的烟火'}}</view>
		        <text class="iconfont iconnext3 c9  fz30"></text>
		    </view>
		    <view class="msg_box" @tap="jump" data-url="/pages/my_xuexiao/my_xuexiao">
