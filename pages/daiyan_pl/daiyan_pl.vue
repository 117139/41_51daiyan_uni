		...
		<view class="container">
		  ...
		  <view v-if="shuru_type" class="sr_view">
		    <textarea class="shuru_box"  auto-focus="true" focus="true" cursor-spacing='140'
		      @confirm="save_pl"  @blur="shuru_guanbi" placeholder="请发表您的评论…"></textarea>
		  ...
		  <view class="bottom_box">
		    <image @tap="shuru" class="edit_icon" src="/static/images/edit_icon.png"></image>
		    <view class="kf_btn">
