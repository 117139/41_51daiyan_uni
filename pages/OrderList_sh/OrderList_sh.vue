		...
		<view class="container" v-if="htmlReset==0">
		  ...
		  <view class="goodsBox w100" v-if="type==idx0" v-for="(item0,idx0) in datalist">
		    ...
		    <view class="goodsBox contbox">
		      <view class="goods" v-for="(item,idx) in goods" :data-tab="idx" @tap="jump" data-url="'/pages/OrderDetails/OrderDetails?shop_id=1&type='+type}}">
		        ...
		        <block v-for="(item1,idx1) in goods">
		          ...
		          <view class="o_cz">
		            <view v-if="type==0" @tap="jump" data-url="/pages/OrderList_sh_tk/OrderList_sh_tk">申请售后</view>
		  ...
		  <view class="vbottom" v-if="type==4">
		    ...
		    <view class="jiesuan" @tap="openOrder">合并代言</view>
		  </view>
